      ...
      <div className="ytgif-wizard-content">
        ...
        <div className="ytgif-feedback-content">
          ...
          <div className="ytgif-support-section">
            ...
            <p>Help YTGify grow by supporting the project:</p>
            <div className="ytgif-support-buttons">
              ...
              <button className="ytgif-support-btn" onClick={handleShare}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <button className="ytgif-support-btn" onClick={handleGitHub}>
