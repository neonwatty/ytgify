...
import { getInjectionManager } from '@/content/injection-manager';
import { getExtensionStateManager } from '@/shared';
import { getYouTubeAPI, YouTubeAPIIntegration } from '@/content/youtube-api-integration';
import { ContentScriptFrameExtractor, ContentFrameExtractionRequest } from '@/content/frame-extractor';
import { getGifProcessor } from '@/content/gif-processor';
import { getPlayerIntegration } from '@/content/player-integration';
import { getPlayerController } from '@/content/player-controller';
import { TimelineOverlayWrapper } from '@/content/timeline-overlay-wrapper';
import { TimelineOverlayWizard } from '@/content/timeline-overlay-wizard';
import { getOverlayStateManager } from '@/content/overlay-state';
import { getCleanupManager } from '@/content/cleanup-manager';
import { initializeContentScriptFrameExtraction } from '@/content/frame-extractor';
...
import NewsletterWizard from '@/content/newsletter-wizard/NewsletterWizard';
