...
import { injectionManager } from '@/content/injection-manager';
import { extensionStateManager } from '@/shared';
import { youTubeAPI, YouTubeAPIIntegration } from '@/content/youtube-api-integration';
import { ContentScriptFrameExtractor, ContentFrameExtractionRequest } from '@/content/frame-extractor';
import { gifProcessor } from '@/content/gif-processor';
import { playerIntegration } from '@/content/player-integration';
...
import { overlayStateManager } from '@/content/overlay-state';
import { cleanupManager } from '@/content/cleanup-manager';
